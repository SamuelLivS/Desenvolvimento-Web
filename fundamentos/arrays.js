...
console.log(valores) // Mas não é boa prática, vai da B.O depois então cria um array para cada tipo de dado
...
//delete funciona também no contexto de objeto, ele deleta chaves e valores dos objetos
console.log(valores)
